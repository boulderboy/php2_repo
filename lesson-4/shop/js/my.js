$(document).ready(function () {
    if($('.loadMore')){
        ...
        $('.loadMore').on('click', function () {
            var lastGood = $('.goodsTable').children().last().data('number');
...
<div class='goodsNameFull'>${goods[good].nameFull}</div>
<div class='goodsPrice'>${goods[good].price}<b>&#8381;</b></div>
<div class='goodsParam'><span><b>Состав: </b></span>${goods[good].param}</div>
</div>
<div class="btnWrap">
